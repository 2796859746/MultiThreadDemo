...
private ImageView imageView;
    ...
    private final String IMGURL = "https://desk-fd.zol-img.com.cn/t_s1920x1080c5/g5/M00/07/07/ChMkJlXw8QmIO6kEABYKy-RYbJ4AACddwM0pT0AFgrj303.jpg\n";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etThread = findViewById(R.id.btn_thread);
        etTask = findViewById(R.id.btn_task);
        etDown = findViewById(R.id.btn_down);
        etImg = findViewById(R.id.btn_img);
        etOther = findViewById(R.id.btn_other);
